...
public class Customer {
    ...
    public void reserveTour(Tour tour){
        if (!tour.isReserved()){
            ...
            System.out.println("Tur"+tour.getTourName()+" paket sizin siyahiya elave edildi");
        }
        else {
            System.out.println("Tur paketi artiq reserve olunub");
        }
    }
    ...
    public void cancelReserve(Tour tour){
        if (reserveTours.contains(tour)){
            ...
            System.out.println("Tur "+tour.getTourName()+"siyahinizdan silindi");
        }
        else {
